    ...
    F: FnOnce(&Linker<CombinedContext>) -> anyhow::Result<()>,
{
    ...
    let engine = Engine::new(&config).with_context(|| format!("error creating wasm context"))?;
    ...
    preview1::add_to_linker_async(&mut linker, |t| &mut t.1)
        .with_context(|| format!("error installing WASI libraries to core engine"))?;
    ...
    linker
        ...
        .with_context(|| format!("Error installing wrought_write_file function"))?;
    ...
    linker
        ...
        .with_context(|| format!("Error installing wrought_read_file function"))?;
    ...
    linker
        ...
        .with_context(|| format!("Error installing wrought_get_metadata function"))?;
    ...
    linker
        ...
        .with_context(|| format!("Error installing wrought_set_metadata function"))?;
    ...
    linker
        ...
        .with_context(|| format!("Error installing wrought_ai_query function"))?;
    ...
    let instance = linker
        ...
        .await
        .with_context(|| format!("Error instantiating WASM engine instance"))?;
    let func = instance
